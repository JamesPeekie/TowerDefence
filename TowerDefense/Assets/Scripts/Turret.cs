...
public class Turret : MonoBehaviour
{
    ...
    [Header("Attributes")]
    [SerializeField]
    private float range = 15f; // Area in which the enemy is detected
    ...
    [Header("Fixed Assets")]
    [SerializeField]
    private string enemyTag = "Enemy"; // Game object that has a tag with this name, ensuring only enemy objects are targeted
    ...
    [Header("Bullet")]
    [SerializeField]
    private GameObject bullet; // Bullet object to spawn on firing
